...
Vstate=-1.85  #-1.89  #-3.19
Vgrange=0.0000000000000000000000000000001152
Vmin=Vstate-Vgrange
Vmax=Vstate+Vgrange
Vnstep=100000000 #230
...
meas.register_custom_parameter('Chemical_potential', setpoints=['Vg', 'Time'])

meas.register_parameter(lockin_B.X, setpoints=['Vdc', 'Vg', 'Time'])
meas.register_parameter(lockin_B.Y, setpoints=['Vdc', 'Vg', 'Time'])
